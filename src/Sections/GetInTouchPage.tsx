        ...
        <section id="getintouch" className="w-full pt-20 px-4 sm:px-6 lg:px-10 py-12 bg-white dark:bg-black transition-colors duration-300">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 max-w-6xl mx-auto">
                ...
                <div className="space-y-8">
                    <h4 className="text-xl font-semibold text-gray-800 dark:text-gray-200">Contact Information</h4>

                    <div className="flex items-start gap-4">
                        <div className="bg-blue-100 dark:bg-blue-900 p-3 rounded-full">
                            <LucideMail className="text-blue-500 dark:text-blue-300" />
                        </div>
                        <div>
                    ...
                    <div className="flex items-start gap-4">
                        <div className="bg-blue-100 dark:bg-blue-900 p-3 rounded-full">
                            <Phone className="text-blue-500 dark:text-blue-300" />
                        </div>
                        <div>
                    ...
                    <div className="flex items-start gap-4">
                        <div className="bg-blue-100 dark:bg-blue-900 p-3 rounded-full">
                            <LucideMapPin className="text-blue-500 dark:text-blue-300" />
                        </div>
                        <div>
                    ...
                    <div className="flex items-center gap-4">
                        <a href="#" className="bg-gray-200 dark:bg-gray-700 p-3 rounded-full hover:scale-105 transition-transform">
                ...
                <div className="space-y-6">
                    <h3 className="text-xl font-semibold text-gray-800 dark:text-gray-200">Send Me a Message</h3>

                    <div className="space-y-4">
                        <div>
                            <label className="block text-sm font-medium text-gray-700 dark:text-gray-300">Your Name</label>
                            <input type="text" className="w-full text-gray-700 dark:text-gray-300 px-4 py-2 mt-1 bg-gray-100 dark:bg-gray-800 border border-gray-300 dark:border-gray-700 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-400 dark:focus:ring-blue-600" />
                        </div>
                        <div>
                            <label className="block text-sm font-medium text-gray-700 dark:text-gray-300">Your Email</label>
                            <input type="email" className="w-full text-gray-700 dark:text-gray-300 px-4 py-2 mt-1 bg-gray-100 dark:bg-gray-800 border border-gray-300 dark:border-gray-700 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-400 dark:focus:ring-blue-600" />
                        </div>
                        <div>
                        ...
                        <div>
                            ...
                            <textarea rows={4} className="w-full px-4 text-gray-700 dark:text-gray-300 py-2 mt-1 bg-gray-100 dark:bg-gray-800 border border-gray-300 dark:border-gray-700 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-400 dark:focus:ring-blue-600" />
                        </div>
                    </div>
