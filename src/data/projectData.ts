...
export const projects = [
    {
        id: 1,
        title: "E-tutor-lms",
        description: "A comprehensive online learning management system with course management and payment integration.",
        image: Etutor,
    ...
    },
    {
        ...
        description: "An app to track workouts, monitor progress, and sync fitness data across multiple devices.",
        image: FitnessApp,
    ...
    },
    {
        ...
        description: "A modern dashboard redesign focusing on improved UI/UX and user experience.",
        image: GrabIT,
        technology: ["Figma"],
        category: "UI/UX",
    ...
    },
    {
        ...
        description: "A robust system to manage student records, attendance, and academic information efficiently.",
    ...
    },
    {
        ...
        description: "A web application to manage book inventories, borrowing, and member details for libraries.",
        technology: ["React","Node js","Vite","Tailwind CSS"],
